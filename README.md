...
```javascript
import gcircshift from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcircshift@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcircshift@deno/mod.js';
```
...
[@stdlib/blas/ext/base/dcircshift]: https://github.com/stdlib-js/blas-ext-base-dcircshift/tree/deno

[@stdlib/blas/ext/base/scircshift]: https://github.com/stdlib-js/blas-ext-base-scircshift/tree/deno
